...
public class GameManager : Singleton<GameManager>
{
    ...
    public void UpdatePlayers()
    {
        ...
        BattleUIManager.Instance.CreateNewVisualsForCharacters(GameManager.Instance.allMonsters);
    }
    ...
    public IEnumerator BattleSym()
    {
        ...
        InitMonsters();
        InitTurnOrderList();
        var message = new MessageBattleStart();
    ...
    {
        UtilsMono.Instance.DestroyAllChildObjects(ref BattleUIManager.Instance.enemyVisualsPanel);
        allMonsters.Clear();
