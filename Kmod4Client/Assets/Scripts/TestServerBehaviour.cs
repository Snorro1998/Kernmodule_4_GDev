...
public class TestServerBehaviour : V2Singleton<TestServerBehaviour>
{
    ...
    private bool aliveCheckCoroutineRunning = false;
    ...
    private Lobby GetPlayerLobby(NetworkConnection nw)
    {
        ...
        {
            foreach (string s in llob.playerNames)
            {
                if (s == nname)
                {
                    lob = llob;
    ...
    public bool CheckIfLobbyExists(string _lobbyName, int _lobbyID)
    {
    ...
    {
        aliveCheckCoroutineRunning = true;
        ...
        aliveCheckCoroutineRunning = false;
    }
    ...
    protected override void Awake()
    {
        ...
        /*
        Lobby lob = new Lobby("Testlobby", 0, Lobby.State.waiting, new List<string>());
        Lobby lob2 = new Lobby("Testlobby2", 1, Lobby.State.inGame, new List<string>());
        Lobby lob3 = new Lobby("Testlobby3", 2, Lobby.State.defeated, new List<string>());
        lobbies.Add(lob);
        lobbies.Add(lob2);
        lobbies.Add(lob3);*/
    }
